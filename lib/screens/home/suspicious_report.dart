...
import 'package:home_cure/models/repor_status.dart';
                          ...
                          if (isVehicleSuspicious(_currentVehiclePlate)) {
                            ...
                            setState(() {
                              Navigator.push(
                                context,
                                MaterialPageRoute(
                                    builder: (context) => detailSuspicious(
                                        _currentVehiclePlate, vehicleT)),
                              );
                            });
                          } else {
                            setState(() {
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 10),
              ElevatedButton.icon(
                  icon: Icon(Icons.add_photo_alternate, color: Color(0xFF015C92)),
                  style: ElevatedButton.styleFrom(
                ...
                child: Container(
                  ...
                  child: ElevatedButton(
                      onPressed: () {
                        ...
                        SuspiciousEventReport suspiciousEventReport =
                            SuspiciousEventReport(
                                Vehicle(widget.carPlate, null, widget.vehicleType)
                                    .toMap(),
                                _currentAddress,
                                _currentDesc);
                        suspiciousEventReport.imageUrl = _currentUrl;
                        _dbService.addSuspiciousEvent(suspiciousEventReport,
                            _dbService.getSelectedCollection("suspiciousEvent"));

                        // Resources.vehiclePlates.add(widget.carPlate);
                        Resources.registeredVehiclelist
                            .add(Vehicle(widget.carPlate, DateTime.now(), 0));
                        //add to status
                        Resources.reportStatusList.add(ReportStatus(
                            "S${suspiciousEventReport.eventId!}",
                            "suspicious vehicle ${widget.carPlate}",
                            0,
                            ''));
